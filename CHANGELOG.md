...
- `--scan` proposes, for Japanese narration, the kanji compounds that the Japanese front end assembles from separate words, together with the reading that assembly gives them; these are the words whose readings are unsettled and that otherwise have to be found by listening.
